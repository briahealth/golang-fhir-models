...
type Communication struct {
	...
	Sent                  *string                `bson:"sent,omitempty" gorm:"type:dateTime" json:"sent,omitempty"`
	Received              *string                `bson:"received,omitempty" gorm:"type:dateTime" json:"received,omitempty"`
