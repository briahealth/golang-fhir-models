...
type Communication struct {
	...
	Sent                  *string                `bson:"sent,omitempty" gorm:"type:timestamp" json:"sent,omitempty"`
	Received              *string                `bson:"received,omitempty" gorm:"type:timestamp" json:"received,omitempty"`
