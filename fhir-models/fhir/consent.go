...
type Consent struct {
	...
	DateTime          *string               `bson:"dateTime,omitempty" gorm:"type:timestamp" json:"dateTime,omitempty"`
...
type ConsentVerification struct {
	...
	VerificationDate  *string     `bson:"verificationDate,omitempty" gorm:"type:timestamp" json:"verificationDate,omitempty"`
}
