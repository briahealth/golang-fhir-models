...
type NutritionProduct struct {
	...
	ProductCharacteristic []NutritionProductProductCharacteristic `bson:"productCharacteristic,omitempty" json:"productCharacteristic,omitempty"`
...
type NutritionProductInstance struct {
	...
	Expiry            *string      `bson:"expiry,omitempty" gorm:"type:timestamp" json:"expiry,omitempty"`
	UseBy             *string      `bson:"useBy,omitempty" gorm:"type:timestamp" json:"useBy,omitempty"`
}
