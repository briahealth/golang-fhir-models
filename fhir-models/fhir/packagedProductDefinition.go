...
type PackagedProductDefinition struct {
	...
	Package               *PackagedProductDefinitionPackage              `bson:"package,omitempty" json:"package,omitempty"`
}
...
type PackagedProductDefinitionPackage struct {
	...
	ShelfLifeStorage  []PackagedProductDefinitionPackageShelfLifeStorage `bson:"shelfLifeStorage,omitempty" json:"shelfLifeStorage,omitempty"`
	Manufacturer      []Reference                                        `bson:"manufacturer,omitempty" json:"manufacturer,omitempty"`
	Property          []PackagedProductDefinitionPackageProperty         `bson:"property,omitempty" json:"property,omitempty"`
	ContainedItem     []PackagedProductDefinitionPackageContainedItem    `bson:"containedItem,omitempty" json:"containedItem,omitempty"`
	Package           []PackagedProductDefinitionPackage                 `bson:"package,omitempty" json:"package,omitempty"`
}
